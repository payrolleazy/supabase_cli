drop trigger if exists "trg_i06_proof_entity_set_updated_at" on "public"."i06_proof_entity";
...
drop trigger if exists "trg_platform_i06_maintenance_run_set_updated_at" on "public"."platform_i06_maintenance_run";
...
alter table "public"."i06_proof_entity" drop constraint "i06_proof_entity_tenant_id_fkey";
...
alter table "public"."platform_hierarchy_backup_log" drop constraint "platform_hierarchy_backup_log_tenant_id_fkey";

alter table "public"."platform_hierarchy_error_log" drop constraint "platform_hierarchy_error_log_tenant_id_fkey";

alter table "public"."platform_hierarchy_health_status" drop constraint "platform_hierarchy_health_status_tenant_id_fkey";

alter table "public"."platform_hierarchy_maintenance_lock" drop constraint "platform_hierarchy_maintenance_lock_tenant_id_fkey";

alter table "public"."platform_hierarchy_maintenance_run" drop constraint "platform_hierarchy_maintenance_run_refresh_run_id_fkey";

alter table "public"."platform_hierarchy_metadata" drop constraint "platform_hierarchy_metadata_tenant_id_fkey";

alter table "public"."platform_hierarchy_performance_log" drop constraint "platform_hierarchy_performance_log_tenant_id_fkey";
...
alter table "public"."platform_wcm_lifecycle_event_queue" drop constraint "platform_wcm_lifecycle_event_queue_request_id_fkey";

alter table "public"."platform_wcm_lifecycle_rollback_audit" drop constraint "platform_wcm_lifecycle_rollback_audit_request_id_fkey";
...
drop view if exists "public"."platform_rm_hierarchy_org_chart_cached";

drop materialized view if exists "public"."platform_rm_hierarchy_org_chart_cached_store";
...
alter table "public"."platform_hierarchy_error_log" alter column "error_log_id" set default nextval('public.platform_hierarchy_error_log_error_log_id_seq'::regclass);

alter table "public"."platform_hierarchy_performance_log" alter column "performance_log_id" set default nextval('public.platform_hierarchy_performance_log_performance_log_id_seq'::regclass);

alter table "public"."platform_wcm_lifecycle_rollback_audit" alter column "audit_id" set default nextval('public.platform_wcm_lifecycle_rollback_audit_audit_id_seq'::regclass);
...
alter table "public"."platform_hierarchy_backup_log" add constraint "platform_hierarchy_backup_log_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.platform_tenant(tenant_id) ON DELETE CASCADE not valid;

alter table "public"."platform_hierarchy_backup_log" validate constraint "platform_hierarchy_backup_log_tenant_id_fkey";

alter table "public"."platform_hierarchy_error_log" add constraint "platform_hierarchy_error_log_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.platform_tenant(tenant_id) ON DELETE SET NULL not valid;

alter table "public"."platform_hierarchy_error_log" validate constraint "platform_hierarchy_error_log_tenant_id_fkey";

alter table "public"."platform_hierarchy_health_status" add constraint "platform_hierarchy_health_status_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.platform_tenant(tenant_id) ON DELETE CASCADE not valid;

alter table "public"."platform_hierarchy_health_status" validate constraint "platform_hierarchy_health_status_tenant_id_fkey";

alter table "public"."platform_hierarchy_maintenance_lock" add constraint "platform_hierarchy_maintenance_lock_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.platform_tenant(tenant_id) ON DELETE CASCADE not valid;

alter table "public"."platform_hierarchy_maintenance_lock" validate constraint "platform_hierarchy_maintenance_lock_tenant_id_fkey";

alter table "public"."platform_hierarchy_maintenance_run" add constraint "platform_hierarchy_maintenance_run_refresh_run_id_fkey" FOREIGN KEY (refresh_run_id) REFERENCES public.platform_read_model_refresh_run(id) ON DELETE SET NULL not valid;

alter table "public"."platform_hierarchy_maintenance_run" validate constraint "platform_hierarchy_maintenance_run_refresh_run_id_fkey";

alter table "public"."platform_hierarchy_metadata" add constraint "platform_hierarchy_metadata_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.platform_tenant(tenant_id) ON DELETE CASCADE not valid;

alter table "public"."platform_hierarchy_metadata" validate constraint "platform_hierarchy_metadata_tenant_id_fkey";

alter table "public"."platform_hierarchy_performance_log" add constraint "platform_hierarchy_performance_log_tenant_id_fkey" FOREIGN KEY (tenant_id) REFERENCES public.platform_tenant(tenant_id) ON DELETE SET NULL not valid;

alter table "public"."platform_hierarchy_performance_log" validate constraint "platform_hierarchy_performance_log_tenant_id_fkey";
...
alter table "public"."platform_wcm_lifecycle_event_queue" add constraint "platform_wcm_lifecycle_event_queue_request_id_fkey" FOREIGN KEY (request_id) REFERENCES public.platform_wcm_resignation_request(request_id) ON DELETE CASCADE not valid;

alter table "public"."platform_wcm_lifecycle_event_queue" validate constraint "platform_wcm_lifecycle_event_queue_request_id_fkey";

alter table "public"."platform_wcm_lifecycle_rollback_audit" add constraint "platform_wcm_lifecycle_rollback_audit_request_id_fkey" FOREIGN KEY (request_id) REFERENCES public.platform_wcm_resignation_request(request_id) ON DELETE CASCADE not valid;

alter table "public"."platform_wcm_lifecycle_rollback_audit" validate constraint "platform_wcm_lifecycle_rollback_audit_request_id_fkey";
...
create or replace view "public"."platform_rm_hierarchy_health_status" as  SELECT tenant_id,
    health_status,
    issue_count,
    checked_at,
    ...
    last_self_test_at,
    details
   FROM public.platform_hierarchy_health_status_rows() platform_hierarchy_health_status_rows(tenant_id, health_status, issue_count, checked_at, last_cache_refresh_at, last_maintenance_at, last_self_test_at, details);


create or replace view "public"."platform_rm_hierarchy_metrics_summary" as  SELECT tenant_id,
    total_position_count,
    active_position_count,
    occupied_position_count,
    vacant_position_count,
    overlap_position_count,
    root_position_count,
    max_hierarchy_level,
    last_cache_refresh_at,
    last_health_status,
    last_health_check_at
   FROM public.platform_hierarchy_metrics_summary_rows() platform_hierarchy_metrics_summary_rows(tenant_id, total_position_count, active_position_count, occupied_position_count, vacant_position_count, overlap_position_count, root_position_count, max_hierarchy_level, last_cache_refresh_at, last_health_status, last_health_check_at);
...
create materialized view "public"."platform_rm_hierarchy_org_chart_cached_store" as  SELECT tenant_id,
    position_id,
    position_code,
    position_name,
    position_group_id,
    ...
    overlap_count
   FROM public.platform_hierarchy_org_chart_cache_seed_rows() platform_hierarchy_org_chart_cache_seed_rows(tenant_id, position_id, position_code, position_name, position_group_id, position_group_code, position_group_name, reporting_position_id, hierarchy_path, hierarchy_level, position_status, active_occupancy_count, direct_report_count, operational_employee_id, operational_employee_code, operational_actor_user_id, operational_employee_name, operational_occupancy_role, overlap_count);
...
create or replace view "public"."platform_rm_hierarchy_position_history" as  SELECT tenant_id,
    occupancy_history_id,
    occupancy_id,
    position_id,
    position_code,
    position_name,
    ...
    event_details,
    created_at
   FROM public.platform_hierarchy_position_history_rows() platform_hierarchy_position_history_rows(tenant_id, occupancy_history_id, occupancy_id, position_id, position_code, position_name, employee_id, employee_code, employee_name, actor_user_id, occupancy_role, event_type, effective_start_date, effective_end_date, event_reason, event_details, created_at);
...
create or replace view "public"."platform_rm_wcm_lifecycle_rollback_audit" as  SELECT audit_id,
    tenant_id,
    request_id,
    employee_id,
    position_id,
...
create or replace view "public"."platform_rm_wcm_resignation_request_catalog" as  SELECT request_id,
    tenant_id,
    employee_id,
    position_id,
    request_status,
...
create or replace view "public"."platform_rm_hierarchy_org_chart_cached" as  SELECT tenant_id,
    position_id,
    position_code,
    position_name,
    position_group_id,
