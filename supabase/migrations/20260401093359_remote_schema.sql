...
alter table "public"."platform_billing_settlement" alter column "credit_applied" set data type numeric(18,2) using "credit_applied"::numeric(18,2);

alter table "public"."platform_billing_settlement" alter column "final_amount" set data type numeric(18,2) using "final_amount"::numeric(18,2);

alter table "public"."platform_billing_settlement" alter column "gross_amount" set data type numeric(18,2) using "gross_amount"::numeric(18,2);

alter table "public"."platform_billing_settlement" alter column "measured_average_users" set data type numeric(10,2) using "measured_average_users"::numeric(10,2);

alter table "public"."platform_billing_settlement" alter column "unit_rate" set data type numeric(18,4) using "unit_rate"::numeric(18,4);

alter table "public"."platform_payment_order" alter column "amount" set data type numeric(18,2) using "amount"::numeric(18,2);

alter table "public"."platform_wallet_balance" alter column "available_credit" set data type numeric(18,2) using "available_credit"::numeric(18,2);

alter table "public"."platform_wallet_balance" alter column "reserved_credit" set data type numeric(18,2) using "reserved_credit"::numeric(18,2);

alter table "public"."platform_wallet_ledger" alter column "amount" set data type numeric(18,2) using "amount"::numeric(18,2);

alter table "public"."platform_wallet_ledger" alter column "balance_after" set data type numeric(18,2) using "balance_after"::numeric(18,2);
